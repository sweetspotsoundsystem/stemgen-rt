...
# Target-Mac follow-up

Machine timing checks passed. Verify the installed plugin under DAW load.
...
4. Compare the installed plugin against your previous installed version.
   Record the DAW, sample rate, buffer, hardware and listening result.
